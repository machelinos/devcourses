...
function everyXsecsForYsecs(func, interval, duration){
    let timerFunction = setInterval(func,interval*1000);
...
SecondClock.prototype.start = function(){
    this.timer = setInterval(this.cb,1000);
}

SecondClock.prototype.reset = function(){
    clearInterval(this.timer);
} */



//Challenge 9 in ES6 Classes
class SecondClock{
    constructor(cb){
        this.cb = cb;
        this.timer = undefined;
